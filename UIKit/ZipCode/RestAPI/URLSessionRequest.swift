...
public class URLSessionRequest {
    ...
    //        let teste = URLSessionRequestRoute.zipcode(cep: string ?? "").route
    //        print(teste)
    ...
    public func execute<ResponseType: Codable>(route: URLSessionRequestRoute, httpMethod: RequestType, response: ResponseType.Type, completion: @escaping (Result<ResponseType, ServiceError>) -> Void) {
        ...
        if httpMethod == .post { //por onde vira o body??
//            do {
...
//            }
    ...
    //TODO: Trasformar este metodo em genérico, receber um route contendo a rota(String) e colocar os metodos como enum tbm 
